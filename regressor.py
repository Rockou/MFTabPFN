    ...
    def predict(  # noqa: C901, PLR0912
        ...
        *,
        ...
        for output, config in self.executor_.iter_outputs(
            ...
            # plt.hist(output[15, :].cpu().detach().numpy(), bins=50, density=True, color='blue', histtype='bar',
            #          edgecolor='white', alpha=0.5, label="PDF")
            # plt.legend()
            # plt.show(block=True)
        ...
        if output_type in ["full", "main"]:
            ...
            variance_out = typing.cast(np.ndarray, logit_to_output(output_type="variance"))
