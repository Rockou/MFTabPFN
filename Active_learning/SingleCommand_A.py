"""
Single-command script to reproduce UQ of ONERA M6 wing on multi-fidelity data
This will produce Fig. 10
...
def run_script(script_name: str):
    ...
    if script_name in ["CD_ONERAM6_MFGPR_M.py", "CD_ONERAM6_NMFGPR_M.py", "CD_ONERAM6_AMFGPR_M.py", "CD_ONERAM6_ANMFGPR_M.py"]:
        env_name = "mftabpfn-gpr"
    else:
        env_name = "mftabpfn-full"

    if script_name in ["CD_ONERAM6_FNO_M.py", "CD_ONERAM6_MAHNN_M.py", "CD_ONERAM6_ML_M.py","CD_ONERAM6_MFGPR_M.py",
                       "CD_ONERAM6_NMFGPR_M.py", "CD_ONERAM6_AMFGPR_M.py", "CD_ONERAM6_ANMFGPR_M.py", "CD_ONERAM6_M_Plot.py"]:
...
def main():
    ...
    scripts_to_run = [
        "CD_ONERAM6_M.py",           # Performance based on AMFTabPFN
        "CD_ONERAM6_FNO_M.py",       # Performance based on TLFNO
        "CD_ONERAM6_MAHNN_M.py",     # Performance based on MAHNN
        "CD_ONERAM6_ML_M.py",        # Performance based on MFTabPFN/TabPFN-H/TabPFN-M/AutoGluon-H/AutoGluon-M
        "CD_ONERAM6_MFGPR_M.py",     # Performance based on MFGPR
        "CD_ONERAM6_NMFGPR_M.py",    # Performance based on NMFGPR
        "CD_ONERAM6_AMFGPR_M.py",    # Performance based on AMFGPR
        "CD_ONERAM6_ANMFGPR_M.py",   # Performance based on ANMFGPR
        "CD_ONERAM6_M_Plot.py",      # Performance plots
    ]
