...
pkl_file = os.path.join(WORK_DIR, 'CL_total_high.pkl')
with open(pkl_file, 'rb') as f:
    CL_total_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'CL_total_low.pkl')
with open(pkl_file, 'rb') as f:
    CL_total_low = pickle.load(f)
...
YY_train_yuan_low = CL_total_low[indices_low, :].ravel()
YY_train_yuan_high = CL_total_high[indices_high, :].ravel()

YY_total_yuan_low = CL_total_low[:N, :].ravel()
YY_total_yuan_high = CL_total_high[:N, :].ravel()
...
# with open('i_CL.pkl', 'wb') as f:
#     pickle.dump(i, f)
# with open('Y_test_prediction_Ad_MFTabPFN_CL.pkl', 'wb') as f:
#     pickle.dump(Y_test_prediction_Ad_MFTabPFN, f)
# with open('YY_total_yuan_high_CL.pkl', 'wb') as f:
#     pickle.dump(YY_total_yuan_high, f)
# with open('RMSE_Ad_MFTabPFN_CL.pkl', 'wb') as f:
#     pickle.dump(RMSE, f)
# with open('MAE_Ad_MFTabPFN_CL.pkl', 'wb') as f:
#     pickle.dump(MAE, f)
# with open('R2_Ad_MFTabPFN_CL.pkl', 'wb') as f:
#     pickle.dump(R2, f)
# with open('JS_Ad_MFTabPFN_CL.pkl', 'wb') as f:
#     pickle.dump(JS, f)
# with open('Index_fidelity_Ad_MFTabPFN_CL.pkl', 'wb') as f:
...
# with open('N_low_call_CL.pkl', 'wb') as f:
#     pickle.dump(N_low, f)
# with open('repeated_values_low_CL.pkl', 'wb') as f:
#     pickle.dump(repeated_values, f)
# with open('repeated_counts_low_CL.pkl', 'wb') as f:
...
# with open('N_high_call_CL.pkl', 'wb') as f:
#     pickle.dump(N_high, f)
# with open('repeated_values_high_CL.pkl', 'wb') as f:
#     pickle.dump(repeated_values, f)
# with open('repeated_counts_high_CL.pkl', 'wb') as f:
#     pickle.dump(repeated_counts, f)
...
# with open('Y_test_prediction_TabPFN_high_CL.pkl', 'wb') as f:
#     pickle.dump(Y_test_prediction_TabPFN_high, f)
# with open('RMSE_TabPFN_high_CL.pkl', 'wb') as f:
#     pickle.dump(rmse, f)
# with open('MAE_TabPFN_high_CL.pkl', 'wb') as f:
#     pickle.dump(mae, f)
# with open('R2_TabPFN_high_CL.pkl', 'wb') as f:
#     pickle.dump(r2, f)
# with open('JS_TabPFN_high_CL.pkl', 'wb') as f:
...
# with open('Y_test_prediction_TabPFN_low_CL.pkl', 'wb') as f:
#     pickle.dump(Y_test_prediction_TabPFN_low, f)
# with open('RMSE_TabPFN_low_CL.pkl', 'wb') as f:
#     pickle.dump(rmse, f)
# with open('MAE_TabPFN_low_CL.pkl', 'wb') as f:
#     pickle.dump(mae, f)
# with open('R2_TabPFN_low_CL.pkl', 'wb') as f:
#     pickle.dump(r2, f)
# with open('JS_TabPFN_low_CL.pkl', 'wb') as f:
#     pickle.dump(js_div, f)
...
# with open('Y_test_prediction_AutoGluon_high_CL.pkl', 'wb') as f:
#     pickle.dump(Y_test_prediction_AutoGluon_high, f)
# with open('RMSE_AutoGluon_high_CL.pkl', 'wb') as f:
#     pickle.dump(rmse, f)
# with open('MAE_AutoGluon_high_CL.pkl', 'wb') as f:
#     pickle.dump(mae, f)
# with open('R2_AutoGluon_high_CL.pkl', 'wb') as f:
#     pickle.dump(r2, f)
# with open('JS_AutoGluon_high_CL.pkl', 'wb') as f:
#     pickle.dump(js_div, f)
...
# with open('Y_test_prediction_AutoGluon_low_CL.pkl', 'wb') as f:
#     pickle.dump(Y_test_prediction_AutoGluon_low, f)
# with open('RMSE_AutoGluon_low_CL.pkl', 'wb') as f:
#     pickle.dump(rmse, f)
# with open('MAE_AutoGluon_low_CL.pkl', 'wb') as f:
#     pickle.dump(mae, f)
# with open('R2_AutoGluon_low_CL.pkl', 'wb') as f:
#     pickle.dump(r2, f)
# with open('JS_AutoGluon_low_CL.pkl', 'wb') as f:
#     pickle.dump(js_div, f)
