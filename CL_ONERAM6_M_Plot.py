...
WORK_DIR = "./Datasets/ONERA_M6/Lift"

pkl_file = os.path.join(WORK_DIR, 'i_CL.pkl')
with open(pkl_file, 'rb') as f:
    i = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'Y_test_prediction_Ad_MFTabPFN_CL.pkl')
with open(pkl_file, 'rb') as f:
    Y_test_prediction_Ad_MFTabPFN = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'YY_total_yuan_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    YY_total_yuan_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'RMSE_Ad_MFTabPFN_CL.pkl')
with open(pkl_file, 'rb') as f:
    RMSE_Ad_MFTabPFN = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'MAE_Ad_MFTabPFN_CL.pkl')
with open(pkl_file, 'rb') as f:
    MAE_Ad_MFTabPFN = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'R2_Ad_MFTabPFN_CL.pkl')
with open(pkl_file, 'rb') as f:
    R2_Ad_MFTabPFN = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'JS_Ad_MFTabPFN_CL.pkl')
with open(pkl_file, 'rb') as f:
    JS_Ad_MFTabPFN = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'Index_fidelity_Ad_MFTabPFN_CL.pkl')
with open(pkl_file, 'rb') as f:
    Index_fidelity_Ad_MFTabPFN = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'N_low_call_CL.pkl')
with open(pkl_file, 'rb') as f:
    N_low_call = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'repeated_values_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    repeated_values_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'repeated_counts_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    repeated_counts_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'N_high_call_CL.pkl')
with open(pkl_file, 'rb') as f:
    N_high_call = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'repeated_values_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    repeated_values_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'repeated_counts_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    repeated_counts_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'Y_test_prediction_TabPFN_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    Y_test_prediction_TabPFN_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'RMSE_TabPFN_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    RMSE_TabPFN_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'MAE_TabPFN_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    MAE_TabPFN_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'R2_TabPFN_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    R2_TabPFN_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'JS_TabPFN_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    JS_TabPFN_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'Y_test_prediction_TabPFN_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    Y_test_prediction_TabPFN_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'RMSE_TabPFN_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    RMSE_TabPFN_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'MAE_TabPFN_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    MAE_TabPFN_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'R2_TabPFN_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    R2_TabPFN_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'JS_TabPFN_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    JS_TabPFN_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'Y_test_prediction_AutoGluon_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    Y_test_prediction_AutoGluon_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'RMSE_AutoGluon_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    RMSE_AutoGluon_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'MAE_AutoGluon_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    MAE_AutoGluon_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'R2_AutoGluon_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    R2_AutoGluon_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'JS_AutoGluon_high_CL.pkl')
with open(pkl_file, 'rb') as f:
    JS_AutoGluon_high = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'Y_test_prediction_AutoGluon_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    Y_test_prediction_AutoGluon_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'RMSE_AutoGluon_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    RMSE_AutoGluon_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'MAE_AutoGluon_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    MAE_AutoGluon_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'R2_AutoGluon_low_CL.pkl')
with open(pkl_file, 'rb') as f:
    R2_AutoGluon_low = pickle.load(f)
pkl_file = os.path.join(WORK_DIR, 'JS_AutoGluon_low_CL.pkl')
with open(pkl_file, 'rb') as f:
...
ax_left.set_xticks([0, 40, 80, 120, 160])
ax_left.set_title('Metrics for lift coefficient', fontsize=12)
...
# for ext in ['png', 'tiff']:
#     plt.savefig(f'Metrics_CL_n.{ext}', dpi=500, bbox_inches='tight', format=ext)
plt.show(block=True)
plt.close(fig)
...
ax.set_title('PDF of lift coefficient', fontsize=12)
...
plt.tight_layout()
# for ext in ['png', 'tiff']:
#     plt.savefig(f'PDF_CL.{ext}', dpi=500, bbox_inches='tight', format=ext)
plt.show(block=True)
plt.close(fig)
